...
{cn}      ●{pe}●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●{cn}●
{cn}      ●{pe}●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●{cn}●
       {lrd}》{pe}●{cn}○○○○○○○○○○{lrd}》》》》{gn}AMI-NOT{lrd}《《《《{cn}○○○○○○○○○○○{pe}●{lrd}《
{cn}      ●{pe}●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●{cn}●
{cn}      ●{pe}●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●{cn}●
{cn}      ●{pe}●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●{cn}●
{cn}      ●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●●	      	      
...
{lgn}  Hexadecimal {yw}={rd}❯❯❯ {lrd}[H]{gn}❯ {be}|      {lgn}CifraDeCesar {yw}={rd}❯❯❯ {lrd}[C]{gn}❯ {be}|
           ...
           {lgn}user {yw}Telegram {lrd}: {pe}@mr_ami_not{cn}
{cn}_____________________________________________________
""")
	Number = input(f"""{lrd}┌─<({cn}hash{gn}AMI-NOT{lrd})-{yw}[~]{lrd}>
└─< ({gn}AMI-NOT{lrd}){pe}* {lrd}>──»  {cn}""")
	if Number == "1":
		Md5()
	elif Number == "2":
		Sha1()
